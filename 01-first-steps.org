...
Other text editors popular among programmers include [[https://www.gnu.org/software/emacs/][Emacs]] (my favourite!), [[https://www.vim.org/][Vim]], [[https://www.sublimetext.com/][Sublime Text]], [[https://atom.io/][Atom]], and [[https://notepad-plus-plus.org/downloads/][Notepad++]].
...
- Try entering the command ~2 + 2~ or ~console.log('Hello, world!')~.
- To exit the REPL, press /control+c/ twice.
