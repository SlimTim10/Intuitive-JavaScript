...
The line must start with the word "const", followed by the name of the variable, the equals sign, and finally the desired value. It is conventional to end all JavaScript statements with a semicolon. In this example, we are defining a variable named "favNumber" and assigning it the number 10 as its value. This variable will always be 10. The equals is the same as in math; left side equals right side. Wherever else in the code we use "favNumber", we can substitute 10, and vice versa.
